...
import cn.liyu.hospital.mapper.PowerRoleMapper;
import cn.liyu.hospital.mapper.PowerRoleResourceRelationMapper;
import cn.liyu.hospital.mapper.dao.PowerRoleDao;
...
public class PowerRoleServiceImpl implements IPowerRoleService {
    ...
    public List<PowerRole> list(String chineseName, Integer pageNum, Integer pageSize) {
        ...
        if (StrUtil.isNotEmpty(chineseName)) {
            example.createCriteria()
