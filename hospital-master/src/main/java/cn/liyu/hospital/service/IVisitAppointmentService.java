...
public interface IVisitAppointmentService {
     ...
     */
    Long insert(VisitAppointmentParam param);
     ...
     * @return 预约记录
     */
    List<VisitAppointment> listByAccountId(Long accountId, Integer status, Integer pageNum, Integer pageSize);
     ...
     * @return 管理端预约列表
     */
    List<AdminAppointmentDTO> listAdminAppointments(Long cardId, Long doctorId, Date day, Integer status,
    ...
    /**
     * 将预约实体转换为DTO（聚合医院/专科/诊室/医生名称 + 支付状态）
     */
    VisitAppointmentDTO convertToDTO(VisitAppointment appointment);

    /**
     * Stream 消费者专用的下单方法（带事务保护）
     */
    @org.springframework.transaction.annotation.Transactional(rollbackFor = Exception.class)
    boolean insertStreamOrder(VisitAppointment appointment);
}