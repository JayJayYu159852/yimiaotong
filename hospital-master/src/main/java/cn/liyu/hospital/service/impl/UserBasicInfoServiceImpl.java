...
import cn.liyu.hospital.component.AliSendSmsComponent;
...
import cn.liyu.hospital.mapper.UserBasicInfoMapper;
import cn.liyu.hospital.service.IRedisService;
...
public class UserBasicInfoServiceImpl implements IUserBasicInfoService {
    ...
    public boolean sendMessage(String phone) {
        ...
        if (mock) {
            log.warn("==========================================");
            log.warn("【模拟短信】手机号: {}  验证码: {}", phone, code);
            log.warn("==========================================");
            return true;
        }
