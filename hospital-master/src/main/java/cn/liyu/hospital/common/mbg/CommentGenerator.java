...
import org.mybatis.generator.api.dom.java.Interface; // 新增导入
...
public class CommentGenerator extends DefaultCommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        boolean isInterface = compilationUnit instanceof org.mybatis.generator.api.dom.java.Interface;
        if (!isInterface && !compilationUnit.getType().getFullyQualifiedName().contains(EXAMPLE_SUFFIX)) {
